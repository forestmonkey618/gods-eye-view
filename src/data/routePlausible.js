...
import { EARTH_RADIUS_M, surfaceM } from './geo.js';

const D2R = Math.PI / 180;
// Kept as the km twin of the canonical metre radius, so this module's
// angular conversions (d13 / R_KM) cannot drift from the distance authority.
const R_KM = EARTH_RADIUS_M / 1000;

/** Great-circle distance in km. Delegates to `data/geo.js`. */
